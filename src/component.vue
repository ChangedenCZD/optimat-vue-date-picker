<template>
  <section class="component-layout ui-picker-date-layout rel">
    ...
    <div class="date-pick-layout bg-white shadow abs over-hidden" v-show="isShowDatePickLayout">
      <table>
        <tr>
          <th class="year-item pdl10 pdr10" v-if="leftMonthDateInfo.date">
            ...
            <img class="year-select-btn last-year-btn left" :src="icons.left" @click="lastMonth"
                 v-if="!isCurrentMonth(currentLeftMonth)"/>
          </th>
          <th class="pdl10 pdr10"></th>
          <th class="year-item pdl10 pdr10 rel" v-if="rightMonthDateInfo.date">
            ...
            <table class="month-layout left-month pdl10 pdr10 pdb10">
              ...
              <tr v-for="row in leftMonthDateInfo.mergeList">
                <td class="date-item"
                    ...
                    v-for="day in row" :date-index="day.index" :date-time="day.time" @click="select(day)">{{day.day}}
                </td>
              </tr>
            </table>
          </td>
